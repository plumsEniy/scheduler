...
@Slf4j
@Component
public class SparkClientPackDownloadEventHandler extends AbstractDolphinSchedulerEventHandler {
    ...
    protected Map<String, Object> getDolphinExecuteEnv(TaskEvent taskEvent, List<String> hostList) {
        ...
        logPersist(taskEvent, "download package info list is : \n" + packInfos);
    ...
    public EventTypeEnum getHandleEventType() {
        return EventTypeEnum.SPARK_CLIENT_PACK_DOWNLOAD_EVENT;
    }
}
