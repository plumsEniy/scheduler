...
/**
 * @description: zk的扩容发布
 * @Date: 2025/6/26 15:23
 * @Author: nizhiqiang
 */

@Component
public class ZkExpansionEventHandler extends AbstractDolphinSchedulerEventHandler {
    ...
    protected boolean checkEventIsRequired(TaskEvent taskEvent) {
        ...
        if (execStage.equalsIgnoreCase("1") && NodeType.NORMAL.equals(nodeType)) {
            return true;
        } else {
            return false;
        }
    ...
    public EventTypeEnum getHandleEventType() {
        return EventTypeEnum.ZK_EXPANSION_DEPLOY;
    }
}
