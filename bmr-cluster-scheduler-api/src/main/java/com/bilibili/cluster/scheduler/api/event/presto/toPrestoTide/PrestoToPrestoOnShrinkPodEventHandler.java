...
@Slf4j
@Component
public class PrestoToPrestoOnShrinkPodEventHandler extends AbstractTidePrestoDeployEventHandler {

    @Override
    public EventTypeEnum getHandleEventType() {
        return EventTypeEnum.PRESTO_TO_PRESTO_TIDE_ON_POD_FAST_SHRINKAGE;
    }
    ...
    protected Integer getNeedScalePodCount(TaskEvent taskEvent) {
        ...
        return params.getSinkRemainPod();
    }
