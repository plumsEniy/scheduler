...
@Slf4j
public class HboJobParamsDeleteEventPipelineFactory extends AbstractPipelineFactory {
    @Override
    public String identifier() {
        return Constants.HBO_JOB_PARAMS_DELETE_DEPLOY_FACTORY_IDENEITFY;
    }
    ...
    public List<UnResolveEvent> analyzer(PipelineParameter pipelineParameter) {
        ...
        monitorEvent.setEventTypeEnum(EventTypeEnum.HBO_JOB_PARAMS_DELETE);
