...
@Slf4j
@Component
public class PrestoFastExpansionPodEventHandler extends AbstractTidePrestoDeployEventHandler {

    @Override
    public EventTypeEnum getHandleEventType() {
        return EventTypeEnum.PRESTO_POD_FAST_EXPANSION;
    }
    ...
    protected Integer getNeedScalePodCount(TaskEvent taskEvent) {
        ...
        return extFlowParams.getHighPodNum();
    }
}
