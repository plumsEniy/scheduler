...
@Slf4j
@Component
public class PrestoToPrestoTideDeployFlowPrepareGenerateFactory implements FlowPrepareGenerateFactory {
    ...
    public void generateNodeAndEvents(ExecutionFlowEntity flowEntity) throws Exception {
        ...
        PrestoToPrestoTideExtFlowParams prestoTideExtFlowParams = JSONUtil.toBean(flowExtParams, PrestoToPrestoTideExtFlowParams.class);
...
//        prestoTideExtFlowParams.setComponentId(targetNodeManagerMetaData.getId());
    ...
    public List<FlowDeployType> fitDeployType() {
        return Arrays.asList(FlowDeployType.PRESTO_TO_PRESTO_TIDE_ON, FlowDeployType.PRESTO_TO_PRESTO_TIDE_OFF);
    }
    ...
    public List<ResolvedEvent> resolvePipelineEventList(PipelineParameter pipelineParameter) throws Exception {
        PipelineFactory pipelineFactory = FactoryDiscoveryUtils.getFactoryByIdentifier(
                Constants.PRESTO_TO_PRESTO_TIDE_DEPLOY_FACTORY_IDENTIFY, PipelineFactory.class);
