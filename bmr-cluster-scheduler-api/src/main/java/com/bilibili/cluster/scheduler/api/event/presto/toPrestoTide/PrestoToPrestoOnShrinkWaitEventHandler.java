...
@Slf4j
@Component
public class PrestoToPrestoOnShrinkWaitEventHandler extends AbstractTidePrestoWaitEventHandler {
    @Override
    ...
    public EventTypeEnum getHandleEventType() {
        return EventTypeEnum.PRESTO_TO_PRESTO_TIDE_ON_WAIT_SHRINKAGE_POD;
    }
